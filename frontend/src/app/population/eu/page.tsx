...
export default async function EUPopulationPage() {
  ...
  return <main className="mx-auto w-full max-w-6xl flex-1 px-6 py-10">
    ...
    <div className="mt-3 flex flex-wrap items-end justify-between gap-4">
      <div><h1 className="text-2xl font-semibold">欧盟人口与经济结构</h1><p className="mt-1 text-sm text-muted-foreground">以EU27聚合口径观察老龄化、迁移与成员国劳动力供给的长期约束</p><Link href="/employment/eu" className="mt-2 inline-block text-sm text-muted-foreground hover:underline">继续看人口如何转化为就业与产出 →</Link></div>
