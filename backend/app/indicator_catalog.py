    ...
    "PBOC": frozenset(
        {
            ...
            "CN_TSF_YTD", "CN_TSF_RMB_LOANS_FLOW_YTD",
...
_NOT_SEASONALLY_ADJUSTED = frozenset(
    {
        ...
        "CN_GOV_BOND_FINANCING", "CN_TSF_YTD", "CN_TSF_RMB_LOANS_FLOW_YTD",
        "CN_CORP_BOND_FINANCING_YTD", "CN_RE_INVEST_YTD", "CN_RE_INVEST_YTD_YOY",
        "CN_RE_SALES_AREA_YTD", "CN_RE_SALES_AREA_YTD_YOY",
